          ...
          <div className="container text-center text-md-left">
            <div className="row text-center text-md-left mt-1 mb-5">
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-2">
                <h6 className="text-uppercase mb-4 font-weight-bold text-custom-dark"><img src="//openedu.urfu.ru/files/courses_catalog/UrFULogo1.svg" alt="..." className='footer-icon'/>Ural Federal University</h6>
                <p><small className="text-neutral-regular">ФГАОУ ВО «УрФУ имени первого Президента России Б.Н.Ельцина» Институт технологий открытого образования</small></p>
              </div>
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-2">
                ...
                <p>
                <NavLink to='/privacy'  className="text-neutral-regular">Политика конфиденциальности</NavLink>
                </p>
                <p>
                <NavLink to='/tech'  className="text-neutral-regular">Технические требования</NavLink>
                </p>
              </div>
              <hr className="w-200 clearfix d-md-none" />
              <div className="col-md-4 col-lg-4 col-xl-4 mx-auto mt-2">
                ...
                <p  className="text-neutral-regular">
                  ...
                  Екатеринбург,ул. Мира д.19,каб.И-200</p>
                <p  className="text-neutral-regular">
