                ...
                <div className="card animated fadeInRightBig">
                    <div className="row no-gutters cardblock">
                        ...
                        <div className="hovereffect">
                            <img className="img-fluid" src={this.state.link} alt={this.state.name}/>
                        ...
                        <div className="col cardbody">
                            ...
                            <p className="card-title"><strong style={{overflow: 'hidden', textOverflow: 'ellipsis'}}>{this.state.name}</strong></p>
                            <p className="card-text"><small className="text-muted">{this.description(this.state.short_description)}</small></p>
