  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <div
            className="d-flex-column animated fadeIn faster shadow-effect"
            style={{ boxShadow: "0px 0px 20px -8px rgba(169, 169, 169, 0.4)" }}
          >
            <div
            ...
            <div
              className="flex-row d-flex flex-column p-3 text-custom-dark bg-light"
