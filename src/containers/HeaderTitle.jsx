...
const button_enroll = props => {
  return (
    <button
      ...
      className="animated fadeIn btn btn-light btn-lg mt-2 d-flex shadow"
      onClick={props.changeEnroll}
    >
      Записаться на курс
    </button>
  );
...
const ButtonsCoursesEnroll = props => <ButtonEnroll params={props.params.id} isAuth={props.isAuth} changeEnroll={props.changeEnroll} />;
...
const withAuthContionalRendering = withEither(isViewAuthConditionFn, button_enroll);
